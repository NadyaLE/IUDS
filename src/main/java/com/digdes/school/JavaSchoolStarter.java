...
public class JavaSchoolStarter {
    ...
    List<Map<String, Object>> insertMap(Map<String, String> dataString, Map<String, Object> map) {
        if (fillMap(dataString, map).values().stream().allMatch(Objects::isNull)) return null;
        collection.add(map);
        return List.of(map);
    }

    List<Map<String, Object>> selectByCondition(Map<String, Map<String, String>> stringMap) throws Exception {
    ...
    static List<Map<String, Object>> selectMap(Map<String, Class> fieldsAndTypes, List<Map<String, Object>> collection, String condition) throws Exception {
        List<Map<String, Object>> result = new ArrayList<>(collection);
        if (condition.isBlank()) return result;
    ...
    static List<Map<String, Object>> orAndMatcher(Map<String, Class> fieldsAndTypes, List<Map<String, Object>> collection,
    ...
    static Condition findOperation(String condition) throws Exception {
    ...
    static String[] splitCondition(String condition) {
    ...
    static boolean filterMap(Map<String, Class> fieldsAndTypes, Map<String, Object> row, String condition) {
        try {
    ...
    static String getCorrectField(String field, Map<String, Class> fieldsAndTypes) throws Exception {
    ...
    static <K, V> Map<K, V> setKeysInMap(Collection<K> keys, Map<K, V> map) {
